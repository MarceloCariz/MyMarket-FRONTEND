...
import { GridCenter, OptionsTittle } from '@/components/user/cart/ListCart';
import { CartItem } from '@/interfaces';
import { addToCart, changeQuantityProduct, deleteProductCart, removeToCart } from '@/store';
    ...
    <Box>
      <Grid container spacing={2} sx={{ mb: 1, mt: 1 }}>
        ...
        >
          ...
          <OptionsTittle variant='body1'>{getPriceFormatted(price)}</OptionsTittle>
